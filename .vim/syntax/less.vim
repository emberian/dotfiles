...
" Last Change: 2012 February 4
" LESS by Leaf Corcoran
" CSS2 by Nikolai Weibull
" Full CSS2, HTML4 support by Yeti
" CSS3/HTML5 by Corey Richardson
...
syn keyword cssTagName section article aside hgroup header footer nav
syn keyword cssTagName figure figcaption video audio source track embed
syn keyword cssTagName mark progress meter time ruby rt rp bdi wbr canvas
syn keyword cssTagName command details datalist keygen output 
