...
syntax region  javaScriptFuncName       contained matchgroup=javaScriptFuncName start=/\%(\$\|\w\)*\s*/ end=/\s/ contains=javaScriptLineComment,javaScriptComment nextgroup=javaScriptFuncLeftParen skipwhite skipempty
